...
extern uint32_t ulp_dataCheckedCount;
extern uint32_t ulp_dutyCycle;
extern uint32_t ulp_flags;
extern uint32_t ulp_ledVal;
...
extern uint32_t ulp_validatedDutyCycle;
